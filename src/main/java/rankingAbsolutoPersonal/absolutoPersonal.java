 ...
 */
package rankingAbsolutoPersonal;
 ...
 * @author andreea
 */
public class absolutoPersonal extends javax.swing.JFrame {

    /**
     * Creates new form absolutoPersonal
     */
    public absolutoPersonal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(absolutoPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new absolutoPersonal().setVisible(true);
            }
        });
    }
