 ...
 * @author andreea
 */
public class porNivelGlobal extends javax.swing.JFrame {

    /**
     * Creates new form porNivelGlobal
     */
    public porNivelGlobal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(porNivelGlobal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new porNivelGlobal().setVisible(true);
            }
        });
    }
