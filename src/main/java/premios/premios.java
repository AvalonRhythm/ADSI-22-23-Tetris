...
public class premios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¡PREMIOS DISPONIBLES!");

        jLabel2.setText("Ha superado la primera partida del nivel");

        jLabel3.setText("X");

        jLabel4.setText("Ha superado la quinta partida del nivel");

        jLabel5.setText("X");

        volverButton.setBackground(new java.awt.Color(51, 102, 255));
        volverButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        volverButtonLayout.setHorizontalGroup(
                volverButtonLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(volverButtonLayout.createSequentialGroup()
                                .addGap(18, 18, 18)
    ...
    private javax.swing.JLabel jLabel5; //boton volver
