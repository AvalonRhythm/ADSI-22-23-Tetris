 ...
 * @author unai
 */
public class LoginRRSS extends javax.swing.JFrame {
    ...
    private void botonEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonEntrarMouseClicked
        javax.swing.JOptionPane.showMessageDialog(this, "Error de publicación" , "Error", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginRRSS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
